...
import { getAllMainCategories } from "../../api/testmaincategory";
import { createCategory, deleteCategory, getAllCategories, updateCategory } from "../../api/testcategory";
                    ...
                    <table className="min-w-full border border-gray-200">
                        <thead className='bg-gray-100'>
                            <tr>
                                ...
                                <th className="text-left py-2 px-4 border">Main Category</th>
                        ...
                        <tbody>
                            {data.map((item, index) => (
                                <tr key={item.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="py-2 px-4 border">{item.short_name}</td>
                                    <td className="py-2 px-4 border">{mainCategories.find(cat => cat.id === item.main_category_id)?.name}</td>
